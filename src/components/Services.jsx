...
const Services = () => {
  return (
    <section id="services"
      className="flex flex-col bg-[#F7F6F4] py-8 lg:py-16 space-y-3 items-center mt-16"
      data-aos="fade-up"
    ...
    >
      ...
      <p className="text-[#00373E] text-center text-xs lg:text-[14px] md:max-w-[300px] max-w-[250px]">
        Discover expert guidance for a healthier mind and balanced life
      </p>

      {/* Services Row */}
      <div className="grid md:grid-cols-2 gap-4 lg:gap-8 mt-4 md:mt-8 mx-[20px]">
        {/* 1 */}
        <div
          className="flex bg-[#F9E6D0] items-center py-8 px-4 lg:p-6 rounded-3xl"
          data-aos="fade-left"
        ...
        >
          <div className="flex flex-col space-y-5">
            ...
            <p className="text-[#00373E] lg:text-[15px] text-xs max-w-xs">
        ...
        {/* 2 */}
        <div
          className="flex bg-white items-center py-10 px-4 lg:p-6 rounded-3xl"
          data-aos="fade-right"
          data-aos-duration="1500"
        >
          <div className="flex flex-col space-y-5">
        ...
        <div
          ...
          <div className="flex flex-col space-y-6 py-10 px-6">
            ...
            <p className="text-[#00373E] text-xs lg:text-[15px]">
